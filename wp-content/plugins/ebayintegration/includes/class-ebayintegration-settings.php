 ...
 * Settings class file.
 *
 * @package Ebay Integration/Settings
 */
 ...
 * Settings class.
 */
class Ebay_Integration_Settings {
	...
	private function settings_fields() {
		...
		$settings['standard'] = array(
			...
			'fields'      => array(
				...
				array(
					'id'          => 'access_token',
					'label'       => __( 'Access Token', 'ebayintegration' ),
					'description' => __( 'eBay API Access Token.', 'ebayintegration' ),
					'type'        => 'textarea',
					'default'     => '',
					'placeholder' => __( 'eBay API Access Token', 'ebayintegration' ),
				),
				array(
					'id'          => 'refresh_token',
					'label'       => __( 'Refresh Token', 'ebayintegration' ),
					'description' => __( 'eBay API Refresh Token', 'ebayintegration' ),
					'type'        => 'textarea',
					'default'     => '',
					'placeholder' => __( 'eBay API Refresh Token', 'ebayintegration' ),
				)
			),
		);
	...
	/**
	 * Main Ebay_Integration_Settings Instance
	 *
	 * Ensures only one instance of Ebay_Integration_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Ebay_Integration()
	 * @param object $parent Object instance.
	 * @return object Ebay_Integration_Settings instance
	 */
