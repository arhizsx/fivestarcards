...
if( ! isset( $_GET['type'] ) ){
    ...
    $consignment = $this->wpdb->get_results ( "
        ...
        where status IN ('listed', 'sold', 'unsold')
...
<div class="row">
    <div class="col">
        <a class="btn btn-pill btn-sm mb-2 <?php echo $btn_cards; ?>" href="/administrator/consignment/?mode=listed">Cards</a>
        <a class="btn btn-pill btn-sm mb-2 <?php echo $btn_orders; ?>" href="/administrator/consignment/?mode=listed&type=orders">Orders</a>
    </div>
</div>
