...
<div class="container-fluid">
    <div class="row">
        <div class="col-2">
            <a class="5star_btn btn text-left form-control btn-secondary mb-3" data-type="psa-value_bulk" data-action="add_card">
            ...
            <a class="5star_btn btn text-left form-control btn-dark mb-3" data-type="psa-value_bulk" data-action="add_card">
