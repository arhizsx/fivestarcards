    ...
    <table class="table table-sm table-bordered" id="new_consignment">
        ...
        <tbody>
            ...
            <tr class='consigned_item_row' data-id='<?php echo $data["id"] ?>'>
                <td>
                    <a class='text-danger  ebayintegration-btn' data-action="remove_consigned_card_row"  data-id='<?php echo $data["id"] ?>' href='#'>
            ...
            <tr class='consigned_item_row' data-id='<?php echo $data["id"] ?>'>
                <td>
                    <div class='w-100 p-0 text-end' style='position: relative;'>
                        <a class='text-danger ebayintegration-btn' data-action="remove_consigned_card_row" data-id='<?php echo $data["id"] ?>' href='#' style='position: absolute; right: 0px;'>
