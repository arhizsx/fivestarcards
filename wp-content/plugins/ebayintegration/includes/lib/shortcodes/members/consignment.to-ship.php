    ...
    <table class="table table-sm table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Order ID</div>
                        <div class='col-md-9'>
                            <?php echo $card->order_id + 1000; ?>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Player</div>
                        <div class='col-md-9'>
                            <?php echo $data["player_name"] ?>								
                        </div>
                    </div>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Year</div>
                        <div class='col-md-9'>
                            <?php echo $data["year"] ?>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Brand</div>
                        <div class='col-md-9'>
                            <?php echo $data["brand"] ?>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Card #</div>
                        <div class='col-md-9'>
                            <?php echo $data["card_number"] ?>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='small text-secondary col-md-3'>Attribute SN</div>
                        <div class='col-md-9'>
