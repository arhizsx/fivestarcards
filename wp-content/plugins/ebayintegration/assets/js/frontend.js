...
jQuery( document ).on("click", ".ebayintegration-btn", function(e){
	...
	// ////////////////////////// //
		...
		$.when( payout ).done( function( payout ){	
			...
			$(document).find(".show_payment_request_modal").find("[name='user_id']").val("");
			$(document).find(".show_payment_request_modal").find("[name='user_email']").val("");
			$(document).find(".show_payment_request_modal").find("[name='user_name']").val("");
			...
			$(document).find(".show_payment_request_modal").find("[name='requested_amount']").val(data["requested_amount"].toFixed(2));
			$(document).find(".show_payment_request_modal").find("[name='cards_count']").val(data["requested_amount"].toFixed(0));
