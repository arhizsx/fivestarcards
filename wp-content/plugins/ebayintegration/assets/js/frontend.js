...
jQuery( document ).on("click", ".ebayintegration-btn", function(e){
	...
	// ////////////////////////// //
		...
		$.when( payout ).done( function( payout ){	
			...
			$(document).find(".show_payment_request_modal").find("[name='requested_amount']").val(data["requested_amount"]);
			$(document).find(".show_payment_request_modal").find("[name='cards_count']").val(data["requested_amount"]);
