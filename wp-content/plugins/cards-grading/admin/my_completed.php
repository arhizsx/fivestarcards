...
<div class="m-0 p-0">
    <H3 style="color: black;">Completed Orders</H3>
    <div class="table-responsive">    
        <table class='table 5star_my_completed table-bordered table-striped'>
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Order #</th>
            ...
            <tbody>
                ...
                ?>
                <tr class="my-completed-row" data-post_id="<?php echo $post->ID; ?>">
