...
?>
    <div class="row mb-5 mt-3">
        <div class="col-xl-12 new_order_fields">
            ...
            ?>
            <select name="select_customer"  class="btn  me-4 " data-show-subtext="true" data-live-search="true" style="border: 1px solid black">
            ...
            <select name="select_grading_type" class="btn  mb-3" data-show-subtext="true" data-live-search="true" style="border: 1px solid black">
