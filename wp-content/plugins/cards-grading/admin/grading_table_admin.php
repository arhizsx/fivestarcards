...
?>
    <div class="row mb-5 mt-3">
        <div class="col-xl-12 new_order_fields">
            ...
            <select name="select_grading_type" class="btn   me-4" data-dselect-search="true" style="border: 1px solid black">
		...
		<div class="modal-content modal-ajax">
			<div class="modal-header bg-dark text-white">
                ...
                <div class="" id="view_card_form_box">
                    ...
                    <div class="modal-footer">
                        <button class="btn border btn-secondary" data-bs-dismiss="modal" >Close</button>
                        <button class="btn border btn-danger 5star_btn" data-action="confirm_admin_delete_manual_order" data-order_number="<?php echo $_GET['order_number'] ?>" data-back="/administrator/grading/?mode=new">Confirm Delete</button>
                    </div>
                </div>
		</div>
	</div>
