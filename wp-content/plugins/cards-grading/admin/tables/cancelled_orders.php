...
<div class="m-0 p-0">
    <H1 style="color: black;">Cancelled Orders</H1>
            ...
            <tbody>
                ...
                ?>
                            <tr class="" data-post_id="<?php echo $post->ID; ?>">
                                ...
                                <td class="text-end">
                                    <button class="5star_btn btn btn-primary mb-3 admin-completed-row" data-action="admin_table_action" data-order_number="1505">
                                        ...
                                    </button>           
                                </td>
                            </tr>
