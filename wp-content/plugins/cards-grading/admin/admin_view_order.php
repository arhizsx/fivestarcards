                        ...
                        <forn id="add_card_form">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    ...
                                    <input type="number" name="grade" style="font-size: 3em !important; text-align: center !important; color: white !important; background-color: black !important;"  value="" data-field_check="required"  class="form-control mb-2"/>
                                </div>
                            </div>
                            <div class="row">
